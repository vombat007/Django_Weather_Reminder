...
SOCIAL_AUTH_USER_MODEL = 'reminder.User'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Django Weather Reminder',
    'DESCRIPTION': 'This application provides a simple weather reminder by email. '
                   'Before use this application need registrate user by email:(api/register/) '
                   'or registrate by github(api/registration/), '
